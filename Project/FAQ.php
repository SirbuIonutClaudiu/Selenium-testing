...
<!-- InstanceEndEditable -->
        ...
        <a href="http://www.jssor.com" style="display:none">Bootstrap Carousel</a>
                ...
                <div id="content-wrapper">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque at eros a nunc rhoncus iaculis. Pellentesque varius laoreet metus tincidunt feugiat. Nulla pretium cursus nisi ut vulputate. Pellentesque sit amet rhoncus neque. Phasellus euismod nisi et vulputate convallis. Vestibulum porta aliquet malesuada. Morbi lacus magna, lobortis maximus sem at, dignissim malesuada velit.</p> <br>
                    
                    <h2> Most Pupular Questions </h2>
                    <ul class="faq">
                    
                    <li><span>Lorem ipsum dolor sit amet, ligula maecenas elementum etiam, eos nam rhoncus nibh, in quisquam in orci leo, fusce elementum iaculis a? <br> <br>
                    Arcu nunc vitae sollicitudin ipsum amet convallis, urna diam vitae imperdiet curae sodales, sapien nullam morbi faucibus facilisis pede.</span> </li>  <br>
                    <li><span> Lorem ipsum dolor sit amet, wisi risus enim velit tellus ac, facilisis scelerisque est vivamus dolor sit, amet velit dui viverra in aliquam dis?  <br> <br>
                    Suscipit non nisl vestibulum, ipsum dolor pellentesque arcu tempus, vel morbi duis lacinia nam, amet curabitur duis molestie eu.
   </span></li> <br>
   					<li><span> Lorem ipsum dolor sit amet, wisi risus enim velit tellus ac, facilisis scelerisque est vivamus dolor sit, amet velit dui viverra in aliquam dis?  <br> <br>
                    Suscipit non nisl vestibulum, ipsum dolor pellentesque arcu tempus, vel morbi duis lacinia nam, amet curabitur duis molestie eu.
  </span> </li> <br>  
                    ...
                    <ol> 
                    <li> Email : </li> 
                    <li><input type="text"   placeholder="Type your email"    name="email" required class="box"></li>
                    <li> Question: </li> 
                    <li><textarea rows = "4" cols = "50" name = "question" placeholder = "Type your question here"  required class="box2"></textarea></li>
                   
                    <li> <input type="submit" value="Send" class="button" onClick="warn()"> </li>
                    </ol>
                    </form>
