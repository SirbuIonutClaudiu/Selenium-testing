...
<ul>
  ...
  <form action = "introduce_movie.php" method = "post" id = "upload_movie" enctype="multipart/form-data" onSubmit="return rightData();"></form>
  ...
  <p> Trailer </p>
  <input type = "text" name = "trailer" id = "trailer" placeholder = "Insert the trailer youtube URL" form = "upload_movie" required class="box">
