...
<script>(function(d, s, id) {
  ...
  <ul>
   ...
   <ul>
         <li><a href="browse.php"><span>Movies</span></a>
         </li>
         <li class='last'><a href="#"><span>Actors</span></a></li>
      </ul>
   </li>
...
<!-- TemplateEndEditable -->
        ...
        <a href="http://www.jssor.com" style="display:none">Bootstrap Carousel</a>
                ...
                <div id="content-wrapper">
                	...
                	<div id="content"><!-- TemplateBeginEditable name="EditRegion2" -->EditRegion2
                    ...
                    <img src="../Recomandare1.jpg" id="Image1" onMouseOver="MM_swapImage('Image1','','../Recomandare1C.jpg',1)" onMouseOut="MM_swapImgRestore()">
                    ...
                    <div id="box2">
                    <img src="../Recomandare2.jpg" id="Image2" onMouseOver="MM_swapImage('Image2','','../Recomandare2C.jpg',1)" onMouseOut="MM_swapImgRestore()">
